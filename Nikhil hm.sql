...
values
(401,101,'Hypertension','Medication','Amlodipine',201,'2024-02-11'),
(402,102,'Migraine','Therapy','Sumatriptan',202,'2024-03-06'),
(403,103,'Fracture','Surgery','Painkillers',203,'2024-01-21'),
(404,104,'Skin Allergy','Ointment','Hydrocortisone',204,'2024-02-23'),
(405,105,'Fever','Rest & Fluids','Paracetamol',205,'2024-03-11'),
(406,106,'Pregnancy Check','Monitoring','Vitamins',206,'2024-01-16'),
(407,107,'Ear Infection','Antibiotics','Amoxicillin',207,'2024-02-06'),
(408,108,'Diabetes','MDiet Control','Insulin',208,'2024-03-03');

select*from Medical_Records;

insert into Billing(Bill_ID,Patient_ID,TotalAmount,PaymentStatus,DateIssued)
values
(501,101,5000,'Paid','2024-02-15'),
(502,102,3000,'Pending','2024-03-06'),
(503,103,15000,'Paid','2024-01-21'),
(504,104,7000,'Paid','2024-02-23'),
(505,105,2500,'Pending','2024-03-11'),
(506,106,4000,'Paid','2024-01-16'),
(507,107,6000,'Paid','2024-02-06'),
(508,108,9000,'Pending','2024-03-03');

select*from Billing;

insert into Pharmacy(Med_ID,Med_Name,StockQuantity,Price)
values
(601,'Paracetamol',100,10),
(602,'Amoxicillin',50,20),
(603,'Amlodipine',80,15),
(604,'Insulin',30,50),
(605,'Sumatriptan',20,40),
(606,'Hydrocortisone',25,25),
(607,'Painkillers',60,12),
(608,'Vitamins',90,30);
...
values
(701,'Sunita Sharma','Nurse',991462,1),
(702,'Ramesh Gupta','Receptionist',98743,8),
(703,'Anjali Verma','Lab Technician',80032,2),
(704,'Suresh Mehta','Pharmacist',781400,8),
(705,'SPoonam Kaur','Ward Boy',894211,3),
(706,'Kavita Joshi','Nurse',774112,5),
(707,'Mohit Bansal','Cleaner',993899,6),
(708,'SDeepa Rani','Accountant',98148,8);
